                    ...
                    <v-expansion-panel>
                        ...
                        <v-expansion-panel-content>
                            ...
                            <v-form @submit.prevent="addFilter()">
                                <v-row>
                                    <v-col>
                                        <v-select :items="unusedFilters" v-model="newFilterField" label="New filter field"/>
                                    </v-col>
                                    <v-col>
                                        <v-text-field label="New filter value" v-model="newFilterValue"></v-text-field>
                                    </v-col>
                                    <v-col cols="auto">
...
export default {
    ...
    methods: {
        addFilter(){
            ...
            // OR
            const query = { ...this.$route.query, [this.newFilterField]: this.newFilterValue }
    ...
    computed: {
        ...
        filters: {
            get() {
                ...
                const { to, from, ...fields } = this.$route.query
                return fields
            },
            set(newVal) {
